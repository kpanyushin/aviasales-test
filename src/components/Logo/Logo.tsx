...
const Logo = ({ className }: LogoProps) => (
  <svg className={className} width="82" height="89" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g mask="url(#b)">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M48.92 55.891a.65.65 0 00.314-.589l-.871-17.66-9.237 5.333 6.685 13.076c.077.15.208.263.367.318l.946.327a.649.649 0 00.546-.057l1.25-.748z" fill="#DEE1E3"/>
      <path opacity=".4" fillRule="evenodd" clipRule="evenodd" d="M28.837 47.801l-.09.052 1.817 4.075a.65.65 0 00.58.385l.499.01a.65.65 0 00.654-.555l.726-4.935-.463.268a1.63 1.63 0 01-.459.18c-.55.123-1.946.414-3.264.52z" fill="#DEE1E3"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M39.248 43.213l9.13-5.27.099 2.01-7.521 6.6-1.708-3.34z" fill="#C5C6CC"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M57.482 32.952l-29.79 17.2s-.88-1.588-1.613-2.858a.873.873 0 01-.025-.047c1.352.098 4.073-.012 6.712-1.536l20.625-11.907c2.291-1.323 2.852-3.037 3.162-3.773.478 1.285.93 2.921.93 2.921z" fill="#DEE1E3"/>
    </g>
    <defs>
